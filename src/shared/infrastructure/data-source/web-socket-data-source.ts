...
// Specific message types for your use case
export interface WebSocketUsageMessage {
  deviceId: string;
  power: number;
  voltage: number;
  current: number;
...
export interface WebSocketNotificationMessage {
  type: "notification" | "alert" | "warning";
  title: string;
  message: string;
  data?: unknown;
}
...
export const createUsageWebSocketDataSource = (
  url: string,
  authToken?: string
): WebSocketDataSource<WebSocketUsageMessage> =>
  new WebSocketDataSource<WebSocketUsageMessage>({
    url,
    authToken,
    excludeAuthToken: !authToken,
    enableRetry: true,
    enableLogging: true,
...
export const createNotificationWebSocketDataSource = (
  url: string,
  authToken?: string
): WebSocketDataSource<WebSocketNotificationMessage> =>
  new WebSocketDataSource<WebSocketNotificationMessage>({
    url,
    authToken,
    excludeAuthToken: !authToken,
    enableRetry: true,
