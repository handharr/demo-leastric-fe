        ...
        <>
          ...
          <div
            className={clsx(
              ...
              // Medium: fixed center positioning
              "md:fixed md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 md:w-[90vw]",
              // Large: absolute positioning relative to container with proper z-index
